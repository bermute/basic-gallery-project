...
// 로그인
export const longin = (args) => {// 로그인 처리하는 메서드
    return axios.post("/v1/api/accounts/togin")
};

// 로그인 여부 확인
export const check = () => {// 로그인 여부 메서드
    return axios.get("/v1/api/accounts/check").catch(e => e.response);
};
